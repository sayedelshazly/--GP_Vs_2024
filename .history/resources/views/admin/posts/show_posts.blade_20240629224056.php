                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr>
                                            ...
                                            <td class="">
                                                <a class=""
                                                    href="{{url('accept_user_post', $post->id)}}"><i class="text-success mx-3 fs-2 bi bi-check-square-fill"></i></a>
                                                <a class=""
                                                    href="{{url('reject_user_post', $post->id)}}"><i class="text-secondary fs-2 bi bi-x-square-fill"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    @endforeach
