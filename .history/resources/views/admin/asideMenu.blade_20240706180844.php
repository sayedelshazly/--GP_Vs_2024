<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" style="background-color: #37517e !important;" >
    <div class="app-brand demo">
        <a href="/" class="app-brand-link">
            <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">ThinkTank</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="bi bi-tag-fill mx-2"></i>
                <div data-i18n="Account Settings">Category Book</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{url('create_cat_book')}}" class="menu-link">
                        <div data-i18n="Account">Create</div>
                    </a>
                </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="bi bi-bag-check-fill mx-2"></i>
                <div data-i18n="Account Settings">Orders</div>
            </a>
            <ul class="menu-sub">
                
                <li class="menu-item">
                    <a href="{{url('show_orders')}}" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{url('create_book')}}" class="menu-link">
                        <div data-i18n="Account">Create</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{url('show_books')}}" class="menu-link">
                        <div data-i18n="Notifications">Books</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{url('borrow_requests')}}" class="menu-link">
                        <div data-i18n="Notifications">Book Borrow Requests</div>
                    </a>
                </li>
