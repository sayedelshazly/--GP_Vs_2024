        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                {{-- <div class="content-wrapper"> --}}
                    <!-- Content -->
                    <h1 class="text-center text-uppercase mt-5">All Borrow Requests</h1>

                    <div class="row mx-5" style="margin-top: 100px">

                        <div class="card">
                            <h5 class="card-header">All Borrow Requests</h5>
                            <!-- Search -->
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{$borrow->user->email}}</strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge bg-label-secondary">{{$borrow->status}}</span>
                                                @elseif($borrow->status == 'Approved')
                                                <span class="badge bg-label-primary">{{$borrow->status}}</span>
                                                @elseif ($borrow->status == 'Rejected')
                                                <span class="badge bg-label-danger">{{$borrow->status}}</span>
                                                @else
                                                <span class="badge bg-label-sec">{{$borrow->status}}</span>
                                                @endif
                                                
                                            </td>

                                            <td>
                                                <img src="bookImages/{{$borrow->book->book_img}}" style="width: 50px;"
                                                    alt="">
                                            </td>
                                            {{-- <td>
