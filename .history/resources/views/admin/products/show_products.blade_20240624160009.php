                        ...
                        <div class="card">
                            ...
                            <div class="navbar-nav align-items-center">
                                <div class="nav-item d-flex align-items-center">
                                    ...
                                    <form action="{{url('search_products')}}" method="get"></form>
                                </div>
                            </div>
                            <!-- /Search -->
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr>
                                            ...
                                            <td>
                                                <img src="productImages/{{$product->image}}" style="width: 80px;"
                                                    alt="">
                                            </td>
                                            <td class="text-black">{{$product->category}}</td>
                                            <td class="d-flex justify-content-start">
                                                <button class="btn btn-info">
                                                    <a class="text-white" href="{{url('edit_products', $product->id)}}">
                                                        <i class="bx bx-edit-alt me-1"></i>
                                                    </a>
                                                </button>
                                                <button class="btn btn-danger">
                                                    <a class="text-white"
                                                        href="{{url('delete_products', $product->id)}}">
                                                        <i class="bx bx-trash-alt me-1"></i>
                                                    </a>
                                                </button>
                                                {{-- <form action="{{url('delete_products', $product->id)}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
