<section id="hero" class="hero section">
    ...
    <div class="container">
        ...
        <div class="row gy-4">
            <div class="w-75 mx-auto text-center d-flex flex-column justify-content-center p-5 rounded"
                style="background-color: #7695cb36;z-index:200" ; data-aos="zoom-out">
                <p class="fs-1 text-light">Learn Programming Topics and Web development <i
                        class="bi bi-emoji-smile text-info"></i></p>
