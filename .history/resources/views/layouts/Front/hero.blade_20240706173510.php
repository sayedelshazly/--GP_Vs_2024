<section id="hero" class="hero section">
    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img mx-5" data-aos="zoom-out" data-aos-delay="200">
                <img src="assets/img/hero-img.webp" class="img-fluid animated" style="width:400px" alt="">
            </div>
        </div>
    </div>
