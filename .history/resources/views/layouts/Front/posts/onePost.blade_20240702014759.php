            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        ...
                        @if (Auth::check() && Auth::user()->id == $post->user_id || Auth::user()->name == $post->user_id)
                        <div class="d-flex justify-content-start mt-4 align-items-center">
                            <a href="{{url('edit_user_post', $post->id)}}" class="btn btn-gray">
                                <i class="text-info fs-3 bi bi-pencil-square"></i></a>
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h3>Read More About {{$post->title}}</h3>
                        <p class="mt-2">
