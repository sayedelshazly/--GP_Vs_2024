<section id="posts" class="services section">
    ...
    <div class="container">
        <div class="row gy-4">
            @if($posts->isEmpty())
            <p class="text-center badge text-bg-danger w-25 mx-auto my-5">No posts available.</p>
            @endif
            ...
            <div class="d-flex justify-content-center align-items-center mt-5">
                <a href="{{url('showAllPosts')}}" class="">More<i class=" bi bi-chevron-double-right"></i><i
