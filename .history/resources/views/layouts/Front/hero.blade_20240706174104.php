<section id="hero" class="hero section" style="background-color: #fff !important;">
    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center text-info" style="margin-left: -20px" data-aos="zoom-out">
