            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-3 col-md-12 d-flex rounded my-5" data-aos="fade-up" style="width: 300px"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h2 class="card-title text-uppercase">{{$book->title_book}}</h2>
                            <div class="d-flex justify-content-between align-content-center">
                                <span class="p-2 badge text-bg-primary">Author : {{$book->author_name}}</span>
                                <a class="" href="{{url('borrow_book', $book->id)}}"><i class="fs-4 fw-medium bi bi-bookmark-plus"></i></a>
                            </div>
                            <div class="mt-2">
                                <small class="px-2 badge text-bg-secondary">${{$book->price}}</small>
                                <small class="px-2 badge text-bg-dark">{{$book->quantity}}</small>
