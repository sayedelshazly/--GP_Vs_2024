<section id="hero" class="hero section" style="background-image: url('/assets/img/bg-hero.png');">
    ...
    <div class="container">
        ...
        <div class="row gy-4"  >
            <div class="w-75 mx-auto text-center d-flex flex-column justify-content-center p-5 rounded" style="background-color: #8da0ea6f;z-index:200"; data-aos="zoom-out">
