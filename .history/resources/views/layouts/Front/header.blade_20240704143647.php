{{-- <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="d-flex justify-content-center w-50 mx-auto">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                <li class="mx-5"><a href="{{url('/')}}" class=""><i class="fs-2 bi bi-house-door-fill"></i></a></li>
                <li class="dropdown"><a href="#" class="fs-5    "><span class="">Posts</span> <i
                ...
                <li class="dropdown"><a href="#" class="fs-5    "><span class=" ">Roadmap</span> <i
                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                    <ul>
