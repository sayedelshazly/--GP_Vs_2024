                        ...
                        <table class="table table-borderless mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-label-warning">{{$cart->user->name}}</span>

                                    </td>
                                    <td>
                                        
                                        <span class="badge bg-label-warning">{{$cart->product->price}}</span>

                                    </td>
                                    <td>
                                        <span class="badge bg-label-primary">{{$cart->product->category}}</span>
                                    </td>
                                    <td>
