...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="m-top">
            <div class="container">
                <div class="row">
                    <h1 class="text-center mt-5 text-uppercase p-2 rounded w-auto mx-auto" style="font-size: 40px; color:#1f3a69; border:#1f3a69 3px !important">Basic of programming</h1>
