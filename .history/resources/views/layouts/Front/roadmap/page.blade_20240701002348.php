...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="m-top">
            <div class="container">
                <div class="row">
                    <h1 class="text-center mt-5 text-uppercase border border-1 border-5 p-2 rounded w-auto mx-auto" style="font-size: 40px; color:#1f3a69">Basic of programming</h1>
