    ...
    <div class="d-flex justify-content-center w-50 mx-auto">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <a class="" href="{{url('myCart')}}"><i class="text-primary bi bi-bag-heart-fill fs-4" style="color: #fb3200"></i></a>
                <a href="#"><i class="bi bi-star-fill fs-4 mx-3" style="color: #fbc000"></i></a>
