<section id="hero" class="hero section">
    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center" style="margin-left: -50px" data-aos="zoom-out">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
                <img src="assets/img/hero-img.png" class="img-fluid animated w-75" alt="">
            </div>
        </div>
    </div>
