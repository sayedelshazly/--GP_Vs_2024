<section id="hero" class="hero section">
    ...
    <ul class=" list-unstyled bottom-0 mb-5 d-flex mt-5 text-light rounded p-2 position-fixed" style="font-size: 15px; background-color:#37517ebb !important; z-index:1000; ">
