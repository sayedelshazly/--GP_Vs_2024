            ...
            <table class="table align-middle w-75 mx-auto">
                ...
                <tbody class="table-border-bottom-0">
                    <tr>
                        ...
                        <td><span class="badge bg-label-primary">{{$ord->product->category}}</span>
                        </td>
                        <td>
                            <img src="productImages/{{$ord->product->image}}" style="width: 80px;" alt="">
                        </td>
                        <td class="d-flex justify-content-start">
                            <form action="{{url('delete_fromord', $ord->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
