    ...
    @include('layouts.Front.singlePage')
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-xl-3 col-md-6 d-flex bg-body-secondary p-3 rounded" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        <img class="card-img-top" src="bookImages/{{$book->book_img}}" alt="Card image cap" />
                        
                    </div>
                    <div class="card-body ">
                        <h5 class="card-title mx-3 text-uppercase mt-5">{{$book->title_book}}</h5>
                        ...
                        <div class="p-2 d-flex justify-content-between align-items-center ">
                            ...
                            <small class="px-2 badge text-bg-primary d-block">{{$book->quantity}}</small>
                            <br>
