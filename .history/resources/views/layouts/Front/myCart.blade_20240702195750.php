                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            ...
                            <form action="{{url('confirm_order')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn bsb-btn-xl btn-primary" type="submit">Cash On Delivery</button>
                                            <a class="btn btn-danger mt-2 text-uppercase" href="{{url('stripe', $value)}}">Payment <i class=" mx-2 bi bi-credit-card-2-back"></i></a>
                                        </div>
