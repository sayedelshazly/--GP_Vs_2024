<section id="hero" class="hero section">
    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-6 text-center order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            ...
            <ul class=" list-unstyled d-flex text-light rounded p-2 position-fixed" style="font-size: 15px; background-color:#37517ebb !important; z-index:1000">
