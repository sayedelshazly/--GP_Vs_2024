        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                    ...
                    <div class="portfolio-info d-flex justify-content-center align-items-start">
                        <h4>{{$product->title}}</h4>
                        <a href="{{url('show_oneProduct', $product->id)}}" title="More Details" class="details-link"><i
                                class="bi bi-eye-fill"></i></a>
                        <a href="{{url('add_toChart', $product->id)}}" class="px-5"><i
            ...
            <div class="d-flex justify-content-center align-items-center mt-5">
                <a href="{{url('show_allProducts')}}" class="">More<i class=" bi bi-chevron-double-right"></i><i
