    ...
    <div class="d-flex justify-content-center w-50 mx-auto">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li class="dropdown"><a href="#" class="fs-4"><span class="text-light badge text-bg-info px-2">Posts</span> <i
                ...
                <li class="dropdown"><a href="#" class="fs-4"><span class="text-light badge text-bg-info px-2 ">Roadmap</span> <i
                            class="bi bi-chevron-down toggle-dropdown"></i></a>
                    <ul>
