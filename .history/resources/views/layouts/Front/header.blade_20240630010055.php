<header id="header" class="header d-flex align-items-center fixed-top">
    <div class=" d-flex w-50 mx-auto position-relative container-fluid container-xl position-relative d-flex align-items-center">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li class="d-flex align-items-center mx-5">
                    <span class="text-light text-uppercase"><i class="fs-4 bi bi-person-check mx-2"></i> {{
                        Auth::user()->name }}</span>
                </li>
                <li>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-dropdown-link :href="route('logout')" onclick="event.preventDefault();
                        ...
                        <i class="text-light fs-4 bi bi-box-arrow-right"></i>
                    </x-dropdown-link>
                </form>
                </li>
