...
<body class="index-page">
    ...
    <main class="main">
        ...
        <form class="my-5 w-50 mx-auto" action="#" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Name</label>
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" value="{{Auth::user()}}" id="basic-default-name" />
                </div>
            </div>
