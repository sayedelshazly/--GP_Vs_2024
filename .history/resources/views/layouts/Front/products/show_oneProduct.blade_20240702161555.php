                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <p class="mt-5 text-primary">
                                <a href="{{url('add_toChart', $product->id)}}" class=" d-flex justify-content-center ">
                                    <span class="text-uppercase fw-bold fs-3 ">Byu Now!</span>
                                    {{-- <i class="fs-3 bi bi-bag-plus-fill"></i> --}}
                                </a>
                            </p>
                            <div class="p-5 d-flex justify-content-end fw-bold" style="color: #37517e">
                                <a href="{{url('add_toChart', $product->id)}}" class="fs-2 text-uppercase">Orders <i
