            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-default credit-card-box">
                    <div class="panel-heading display-table text-light" style="background-color: #37517e">
                        <h3 class="panel-title my-4 p-3 text-uppercase">Payment Details</h3>
                        <h3 class="panel-title p-3">You need to pay <span class="badge text-bg-light px-4 py-2">$ {{$value}}</span> </h3>
                    </div>
