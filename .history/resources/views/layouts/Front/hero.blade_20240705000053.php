    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
                <img src="assets/img/hero-img.png" class="img-fluid animated" style="width:650px" alt="">
            </div>
        </div>
    </div>

    <ul class="mx-5 list-unstyled badge text-bg-info bottom-0 mb-5 d-flex mt-5 text-light rounded p-2 position-fixed"
        style="font-size: 15px; background-color:#37517e !important; z-index:1000; margin-bottom:150px !important">
        ...
        <li class="mx-2 text-uppercase "><a class="text-light" href="#products">Books</a></li>
