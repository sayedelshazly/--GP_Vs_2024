<section id="hero" class="hero section">
    ...
    <div class="container">
        <div class="row gy-4">
            <div class="w- mx-auto text-center d-flex flex-column justify-content-center" data-aos="zoom-out">
                <h1 class="p-2">Learn Programming Topics and Web development <i class="bi bi-emoji-smile"></i></h1>
    ...
    <ul class=" list-unstyled bottom-0 mb-5 d-flex mt-5 text-light rounded p-2 position-fixed" style="font-size: 15px; background-color:#37517ebb !important; z-index:1000; margin-bottom:175px !important">
