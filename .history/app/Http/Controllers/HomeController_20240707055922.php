...
class HomeController extends Controller
{
    ...
    public function book_history(){
        if(Auth::id()){
            ...
            return view('layouts.Front.history_book', compact('borrow'));
        }
    }
    ...
    // ________________________________________Courses

    public function course_page(){
        return view('layouts.Front.courses.course');
    }
    public function store(Request $request){
        // $request->validate([
        //     'file' => 'required|file|max:200240', // 10 MB = 10240 KB
        // ]);
        $course = new Course;
    ...
    public function show(){
        $course = Course::all();
        return view('layouts.Front.courses.show_coursers', compact('course'));

    }
    public function download_course(Request $request, $file){
        return response()->download(public_path('assets/'.$file));
    }
    public function view_course($id){
        $course = Course::findOrFail($id);
        return view('layouts.Front.courses.view_courser', compact('course'));
    }
}