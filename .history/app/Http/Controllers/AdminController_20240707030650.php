...
class AdminController extends Controller
{
    public function index(){
        ...
        $borrow = Borrow::get()->count();

        return view('admin.index', compact('users', 'posts', 'products', 'cat', 
        'posts_active', 'posts_pending', 'order', 'order_onTheWay', 'book', 'borrow'));
        }
    }
...
public function search_book(Request $request){
    ...
    return view('admin.products.show_products', compact('book'));
