...
class AdminController extends Controller
{
    public function index(){
        ...
        // $order_onTheWay = Order::where('status', 'onTheWay')->get()->count();
        return view('admin.index', compact('users', 'posts', 'products', 'cat', 'order', 'posts_active', 'posts_pending', 'order_onTheWay'));
    }
    ...
    public function edit_cat_book($id){
        $cat_boo = CategortBook::findOrFail($id);
        return view('admin.categories_book.edit_cat', compact('cat'));
    }
    // public function update_cat(Request $request, $id){
    //     $cat = Category::findOrFail($id);
    //     $cat->category_name = $request->category_name;
