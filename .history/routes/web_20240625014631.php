...
Route::post('show_Products', [HomeController::class, 'show_Products'])->middleware('auth');
Route::post('showAllProducts', [HomeController::class, 'showAllProducts'])->middleware('auth');
