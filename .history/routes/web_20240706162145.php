...
Route::get('/ApproveRequest/{id}', [AdminController::class, 'approvedRequest']);
Route::get('/ReturnRequest/{id}', [AdminController::class, 'returnedRequest']);
Route::get('/RejectRequest/{id}', [AdminController::class, 'rejectedRequest']);
