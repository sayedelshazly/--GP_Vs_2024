...
Route::get('Route::get('borrow_book/{id}', [HomeController::class, 'borrow_book'])->middleware('auth');
', [HomeController::class, 'Route::get('borrow_book/{id}', [HomeController::class, 'borrow_book'])->middleware('auth');
'])->middleware('auth');
