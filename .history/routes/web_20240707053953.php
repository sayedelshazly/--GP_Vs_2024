...
// Courses
Route::get('course', [HomeController::class, 'course_page'])->middleware('auth');
Route::get('upload_course', [HomeController::class, 'upload_course'])->middleware('auth');
Route::post('upload_course', [HomeController::class, 'store'])->middleware('auth');
Route::get('show_course', [HomeController::class, 'show'])->middleware('auth');
Route::get('download_course/{file}', [HomeController::class, 'download_course'])->middleware('auth');
Route::get('view_course/{file}', [HomeController::class, 'view_course'])->middleware('auth');
